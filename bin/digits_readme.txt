...
id (0-9) followed by the 256 grayscale values (normalized between -1 and 1).
...
Note that for Programming Assignment #1, only a small set of the training
samples is used with 20 samples for each digit.
